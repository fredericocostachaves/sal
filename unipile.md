            ...
            "multipart/form-data": {
              "schema": {
                ...
                "properties": {
                  ...
                  "voice_message": {
                    "format": "binary",
                    "description": "(Linkedin | WhatsApp) A file to send as voice message. WhatsApp: prefer .mp3 or .m4a. Linkedin: prefer .m4a. Instagram and Telegram: use the attachment field.",
                    "type": "string"
                  },
                  "video_message": {
                    "format": "binary",
                    "description": "(Linkedin) A file to send as video message. WhatsApp: use attachments field.",
                    "type": "string"
                  },
                  "attachments": {
                    "type": "array",
